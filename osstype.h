...
/*****************************************************************************/
/* $Id: 6f2fb972684f260c06eb0754d5624e8d6248f4b3 $ */
/*****************************************************************************/
...
#define CPER_UTF8_COMPAT(g) (((((_EncDecGlobals*)g->encDecVar)->sext.compat_flags & OSS_OLD_UTF8_CHECK) != 0) \
    && !((g)->encRules == OSS_CPER_ALIGNED || (g)->encRules == OSS_CPER_UNALIGNED))
#if ((OSS_COMPILER_API_LEVEL +0) == 40) && !defined(OSS_MULTIPROTOCOL)
...
#define USE_CPP_OPENTYPES    0x4 /* Decoder generates OpenTypeCPP instead of
				  ...
				  * OpenTypeExtended */
#define OSS_RTOED_MEMHDL_MODE  	 0x4000 /* RTOED OSS MEMORY HANDLE in use */
#define OSS_RTOED_MEMHDL_ENABLED 0x8000 /* RTOED OSS MEMORY HANDLE enabled */
...
#ifdef OSS_RTOED_MEMORY_HANDLES_NOT_SUPPORTED
#define WossUserMallocp(w, s)	oss_malloc(s)
#else
#define WossUserMallocp(w, s)	oss_wmalloc(w, s)
#endif
...
#else
#define WossUserFreep(w, v)     oss_wfree(w, v)
#endif
#define WfreepSaved(w, v)	oss_free(v)
#define Wreallocp(w, v, s)	oss_realloc(v, s)
#ifdef OSS_RTOED_MEMORY_HANDLES_NOT_SUPPORTED
#define WossUserRealocp(w, v, s) oss_realloc(v, s)
#else
#define WossUserRealocp(w, v, s) oss_wrealloc(w, v, s)
#endif
#else
...
#define WossUserRealocp(w, v, s) w->c.ossUserRealloc(w, v, s)
#endif

#if defined(OSS_JMPBUF_PROTECTION)
typedef struct oss_jmp_buf {
#ifdef OSS_JMPBUF_PADDING_NEEDED
    char padding[OSS_JMPBUF_PADDING_SIZE];
#endif /* OSS_JMPBUF_PADDING_NEEDED */
    int canary;
    jmp_buf errorBuf;
...
#if defined(_OSS_CODE_FILE) && defined(OSS_TOED_EXER)  \
...
extern void *oss_get_hdl_mem(OssGlobal *world, size_t size);
extern void oss_free_hdl_mem(OssGlobal *world, void *ptr);
extern void *oss_realloc_hdl_mem(OssGlobal *world, void *ptr, size_t size);
